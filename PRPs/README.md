...
- `.github/copilot-instructions.md` — AI agent instructions for the entire codebase
...
Authentication (11) → All features (can be added last)
```
...
*Last Updated: 2026-07-03 | Total PRPs: 11 | Core: 3 | Advanced: 4 | Productivity: 3 | Infrastructure: 1*
